...
function MarsCraterCalcs()
{
	...
	this.G =3711;            		// acceleration due to gravity
	this.R_earth =3390;     		// radius of the earth in km
	...
	this.vEarth = 1.6318  * Math.pow(10,11);		// volume of earth in km^3
	...
	this.lEarth =3.0 * Math.pow(10,44);		// angular momen. of earth in (kg m^3)/sec
	this.lratio;				// ratio of proj ang. momen, to $lEarth
	this.pEarth =1.5* Math.pow(10,25);		// lin. momen of earth in (kg * m) / sec
	this.pratio;				// ratio of proj lin. momen to $pEarth
	this.rhoSurface =0.020;			// suface density of atmosphere kg/m^3
	this.scaleHeight =11100;			// scale height of atmosphere in m
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.getData = function(dataProvider_)
	{	
	...
	**/
	//===================================================================
	MarsCraterCalcs.prototype.doCalcs = function()
	{
	 ...
	 */
	//==================================================================
	 MarsCraterCalcs.prototype.loadParameters = function()
	{
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.main_calculation = function()
	{
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.sentData = function()
	{
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.calc_energy = function()
	{
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.atmospheric_entry = function()
	{
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.find_crater = function()
	{
		var Cd;
		var beta;
		var anglefac;
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.find_ejecta = function ()
	{
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.find_thermal = function()
	{
		var eta;
		var T_star;
		var sigma;
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.find_magnitude = function()
	{	
		var Ax;
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.air_blast = function()
	{
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.print_atmosphere = function()
	{
	 ...
	 */
	//==================================================================
	MarsCraterCalcs.prototype.standform = function( a)
	{
	 ...
	 */
	//============================================================================
	MarsCraterCalcs.prototype.trace = function(s)
	{
